...
# uv run --python 3.14t python -m timeit -n 1 -r 1 -s 'import free_threaded' 'free_threaded.run_fib()'
# uv run --python 3.14t python -m timeit -n 1 -r 1 -s 'import free_threaded' 'free_threaded.run_sleep()'
